...
class VoterAdmin(admin.ModelAdmin):
    ...
    def filter_voters_view(self, request):
        try:
            ...
            voters_data = [{'id': voter.id, 'mlc_constituncy': voter.mlc_constituncy, 'assembly': voter.assembly,
                            'mandal': voter.mandal, 'village': voter.village} for voter in queryset]

            return JsonResponse({'success': True, 'data': voters_data})
